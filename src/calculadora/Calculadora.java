 ...
 * multiplcação e divisão, além de um método principal que seleciona a operação
 ...
 *     <li>Documentação com javaJava</li>
 * 
 * </ul>
...
public class Calculadora {
    ...
    /**
     * <p>Executa a operação matemátiac solicitada com base no operador informado.</p>
     * 
     ...
     * </ul>
     * 
     * <p>Qualquer opoerador inválido esulta em exceção.</p>
     * 
     * @param a primeiro operando
     * @param b segundo operando
     * @param operador símbolo da operação desejada
     * @return o resultado da operação correspondente ao operador
     * 
